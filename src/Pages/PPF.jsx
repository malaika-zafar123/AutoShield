...
function PPF() {
    return (
        <div className="min-h-screen bg-[#0d0d0d]  pt-28">
            ...
            <h2 className="md:text-7xl text-3xl md:max-w-4xl mt-4 md:m-auto font-bold  text-white text-center">
                Premium Paint Protection Film (PPF) in Lahore

            </h2>
            <p className="text-center text-xl md:mt-6 text-gray-300 m-4  max-w-2xl mx-auto">
            ...
            <div className="flex md:flex-row justify-center flex-col gap-5 m-4 md:mt-10">
