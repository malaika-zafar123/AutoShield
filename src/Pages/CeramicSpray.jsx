...
function CeramicSpray(){
    return(
            ...
            <h2 className="md:text-7xl text-3xl md:max-w-4xl m-4 md:m-auto font-bold  text-white text-center">
           Ceramic Paint Protection Spray (PPS)


            </h2>
            <p className="text-center text-xl m-4 md:mt-6 text-gray-300 max-w-2xl mx-auto">
            ...
            <div className="flex md:flex-row justify-center flex-col gap-5 m-6 md:mt-10">
