  ...
  return (
    <section className="bg-[#0D0D0D]  py-24">
      <div className="max-w-7xl mx-auto px-5">
        {/* Heading */}
        <h2 className="md:text-6xl text-3xl font-bold text-white text-center">
          Project{" "}
        ...
        <p className="text-center md:text-xl text-gray-400 mt-5 max-w-2xl mx-auto">
          Browse our work by service category — click any image to view full
          size
        </p>
